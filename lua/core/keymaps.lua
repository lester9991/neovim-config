...
-- Diff keymaps
keymap.set("n", "<leader>cc", ":Gvdiffsplit!<CR>")   -- put diff from current to other during diff
keymap.set("n", "<leader>cj", ":diffget //2<CR>") -- get diff from left (local) during merge
